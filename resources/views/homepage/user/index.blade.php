<x-user.layouts.app>
    <!-- banner-area -->
    <section class="banner-area banner-bg" data-background="{{ asset('images/banner/banner_bg01.jpg') }}">
    ...
    <section class="ucm-area ucm-bg" data-background="{{ asset('images/bg/ucm_bg.jpg') }}">
            ...
            <div class="tab-content" id="myTabContent">
                    ...
                    <div class="ucm-active owl-carousel">
                        <div class="movie-item mb-50">
                            <div class="movie-poster">
                                <a href="movie-details.html"><img src="{{ asset('images/poster/ucm_poster01.jpg') }}" alt=""></a>
                            </div>
                        ...
                        <div class="movie-item mb-50">
                            <div class="movie-poster">
                                <a href="movie-details.html"><img src="{{ asset('images/poster/ucm_poster02.jpg') }}" alt=""></a>
                            </div>
                            <div class="movie-content">
                                <div class="top">
                        ...
                        <div class="movie-item mb-50">
                            <div class="movie-poster">
                                <a href="movie-details.html"><img src="{{ asset(('images/poster/ucm_poster05.jpg')) }}" alt=""></a>
                            </div>
                            <div class="movie-content">
                                <div class="top">
                ...
                <div class="tab-pane fade" id="movies" role="tabpanel" aria-labelledby="movies-tab">
                    <div class="ucm-active owl-carousel">
                        ...
                        <div class="movie-item mb-50">
                            <div class="movie-poster">
                                <a href="movie-details.html"><img src="{{ asset('images/poster/ucm_poster06.jpg') }}" alt=""></a>
                            </div>
                            <div class="movie-content">
                                <div class="top">
                        ...
                        <div class="movie-item mb-50">
                            <div class="movie-poster">
                                <a href="movie-details.html"><img src="{{ asset('images/poster/ucm_poster07.jpg') }}" alt=""></a>
                            </div>
                            <div class="movie-content">
                                <div class="top">
                        ...
                        <div class="movie-item mb-50">
                            <div class="movie-poster">
                                <a href="movie-details.html"><img src="{{ asset('images/poster/ucm_poster08.jpg') }}" alt=""></a>
                            </div>
                            <div class="movie-content">
                                <div class="top">
            ...
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div class="services-img-wrap">
                        <img src="{{ asset('images/images/services_img.jpg') }}" alt="">
                        <a href="{{ asset('images/images/services_img.jpg') }}" class="download-btn" download>Download <img src="{{ asset('images/download.svg') }}" alt=""></a>
                    </div>
                </div>
                <div class="col-lg-6">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-xl-7 col-lg-6">
                    <div class="live-movie-img wow fadeInRight" data-wow-delay=".2s" data-wow-duration="1.8s">
                        <img src="{{ asset('images/images/live_img.png') }}" alt="">
                    </div>
                </div>
            </div>
        </div>
